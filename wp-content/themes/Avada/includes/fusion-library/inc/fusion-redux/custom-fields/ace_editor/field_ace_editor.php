			...
			public function enqueue() {
				if ( ! wp_style_is( 'fusionredux-field-ace-editor-css' ) ) {
					wp_enqueue_style(
						...
						trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/ace_editor/field_ace_editor.css',
						array(),
						false,
						'all'
					);
				...
				if ( ! wp_script_is( 'ace-editor-js' ) ) {
					wp_enqueue_script(
						'ace-editor-js',
						trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/ace_editor/ace.js',
						array( 'jquery' ),
						false,
						true
					);
				...
				if ( ! wp_script_is( 'fusionredux-field-ace-editor-js' ) ) {
					wp_enqueue_script(
						...
						trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/ace_editor/field_ace_editor.js',
