...
// __construct()
			...
			private function set_fusionredux_content() {
				...
				self::$_upload_url = str_replace( array( 'https://', 'http://' ), '//', $upload_dir['baseurl'] . '/fusionredux/' );
			}
			...
			private function _internationalization() {
				...
				$text_domain = wp_normalize_path( FUSION_LIBRARY_PATH . '/inc/fusion-redux/fusionredux-framework/FusionReduxCore/languages/fusionredux-framework-' . $locale . '.mo' );
