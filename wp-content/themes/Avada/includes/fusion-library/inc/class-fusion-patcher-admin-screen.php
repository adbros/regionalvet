										...
										<?php if ( $can_apply ) : ?>
											<form method="post" action="options.php">
												...
												<?php else : ?>
													...
													<?php if ( $patch_failed ) : ?>
														<a class="button" style="margin-top:10px;font-size:11px;color:#b71c1c;display:block;" href="<?php echo esc_url_raw( admin_url( 'admin.php?page=fusion-support&manually-applied-patch=' . $patch_id ) ); ?>"><?php esc_attr_e( 'Dismiss Notices', 'Avada' ); ?></a>
													<?php endif; ?>
												<?php endif; ?>
											</form>
										<?php else : ?>
