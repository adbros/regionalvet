module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		curl: {
			'google-fonts-source': {
				...
				dest: 'inc/fusion-redux/custom-fields/typography/googlefonts.json'
			}
		},
		...
		json2php: {
			convert: {
				expand: true,
				ext: '-array.php',
				src: ['inc/fusion-redux/custom-fields/typography/googlefonts.json']
			}
		},

		// Delete the json array
		clean: [
			'inc/fusion-redux/custom-fields/typography/googlefonts.json',
			'languages/Avada.mo',
			'languages/Avada.po'
		],
		watch: {
		...
		less: {
			...
			development: {
				files: {
					'inc/fusion-redux/assets/style.css': 'inc/fusion-redux/assets/style.less'
				}
			}
		}
	});
	...
	grunt.registerTask( 'default', ['uglify:main', 'less:development', 'curl:google-fonts-source', 'json2php', 'clean'] );
