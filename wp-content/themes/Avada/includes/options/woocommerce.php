...
function avada_options_section_woocommerce( $sections ) {
	...
	$wc_version_greater_than_27 = false;
	if ( defined( 'WC_VERSION' ) ) {
		if ( WC_VERSION && version_compare( WC_VERSION, '2.7.0', '>=' ) ) {
			$wc_version_greater_than_27 = true;
		}
	}
		...
		'fields'   => array(
			'general_woocommerce_options_subsection' => array(
				...
				'fields'      => array(
					...
					'woocommerce_gallery_thumbnail_columns' => ( ( ( class_exists( 'WooCommerce' ) && $wc_version_greater_than_27 ) || Avada::$is_updating ) ) ? array(
