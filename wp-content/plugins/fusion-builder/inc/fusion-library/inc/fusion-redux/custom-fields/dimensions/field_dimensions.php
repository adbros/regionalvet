		...
		class FusionReduxFramework_dimensions {
			...
			function enqueue() {
				...
				wp_enqueue_script(
					...
					trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/dimensions/field_dimensions.js',
				...
				if ( $this->parent->args['dev_mode'] ) {
					wp_enqueue_style(
						...
						trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/dimensions/field_dimensions.css',
						array(),
						time(),
						'all'
					);
