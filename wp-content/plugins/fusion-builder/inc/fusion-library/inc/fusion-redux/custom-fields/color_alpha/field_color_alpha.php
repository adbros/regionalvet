	...
	class FusionReduxFramework_color_alpha {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/color_alpha/wp-color-picker-alpha.js',
				array( 'wp-color-picker' ),
				'1.2'
			);
			wp_enqueue_script(
				'fusionredux-field-color-js',
				trailingslashit( FUSION_LIBRARY_URL ) . 'inc/fusion-redux/custom-fields/color_alpha/field_color_alpha.js',
