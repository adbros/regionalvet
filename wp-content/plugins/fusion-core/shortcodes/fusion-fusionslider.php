		...
		class FusionSC_FusionSlider {
			...
			function render_parent( $args, $content = '' ) {
				...
				if ( $query->have_posts() ) : ?>
					...
					<div <?php echo FusionBuilder::attributes( 'fusion-slider-wrapper' ); ?>>
						...
						.fusion-slider-<?php echo esc_attr( $term_details->term_id ); ?> .flex-direction-nav a {
							...
							if ( $slider_settings['nav_box_height'] ) {
								...
								echo 'margin-top:-' . intval( $nav_box_height_half ) . 'px;';
							}
						...
						<?php // @codingStandardsIgnoreLine ?>
						<div <?php echo FusionBuilder::attributes( 'fusion-slider-container' ); ?>>
							<ul class="slides">
								<?php
	...
	fusion_builder_map( array(
		...
		'params'     => array(
			array(
				...
				'param_name'  => 'name',
				'value'       => fusion_builder_shortcodes_categories( 'slide-page' ),
				'default'     => '',
			),
			array(
...
add_action( 'wp_loaded', 'fusion_element_fusionslider' );
