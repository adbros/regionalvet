...
class MyLiveChat
{
	...
	public function mylivechat_code()
	{
		...
		else
		{
			...
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatbutton.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
			else if($this->get_mylivechat_displaytype()=="box")
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatbox.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
			else
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatlink.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
		}
	}
	...
	public function mylivechat_inlinecode()
	{
		...
		{	
			echo "<script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatinline.aspx?hccid=".$this->get_mylivechat_id()."\"></script>";
		}
	}
	...
	public function mylivechat_widgetcode()
	{
		...
		{	
			echo "<script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatwidget.aspx?hccid=".$this->get_mylivechat_id()."\"></script>";
		}
	}
	...
	public function mylivechat_monitor()
	{
		...
		{
			echo "<script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatapi.aspx?hccid=".$this->get_mylivechat_id()."\"></script>";
